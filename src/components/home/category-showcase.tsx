...
export function CategoryShowcase({ cards }: { cards: ShowcaseCard[] }) {
  return (
    <section
      ...
      className="relative border-b border-[#ececec] py-3 sm:py-4"
    >
      <div className="relative">
        ...
        <div className="grid gap-3 sm:gap-4 md:grid-cols-2 xl:grid-cols-4">
          {cards.map((card) => (
            ...
            >
              <div
                className="relative h-[164px] bg-cover bg-center transition duration-500 group-hover:scale-[1.02] sm:h-[180px] md:h-[168px] xl:h-[150px]"
                style={{
              ...
              <div className="absolute inset-x-[10px] bottom-[10px] flex items-center justify-between bg-white/92 px-3 py-2 shadow-[0_4px_12px_-10px_rgba(0,0,0,0.5)]">
                <h3 className="font-display text-[18px] leading-none text-[#222] sm:text-[19px]">
                  {card.title}
                </h3>
